...
public class MarketplaceWebServiceProductsSampleConfig {
    ...
    private static final String accessKey = "AKIAJAQDO7H3Z3KGQDIQ";

    /** Developer AWS secret key. */
    private static final String secretKey = "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";

    /** The client application name. */
    private static final String appName = "O2R-Product";
     ...
     */
    private static final String serviceURL = "https://mws.amazonservices.in";
