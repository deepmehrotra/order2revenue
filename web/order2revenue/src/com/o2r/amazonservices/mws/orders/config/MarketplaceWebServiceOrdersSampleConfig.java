 ...
 */
package com.o2r.amazonservices.mws.orders.config;
...
public class MarketplaceWebServiceOrdersSampleConfig {
    ...
    private static final String accessKey = MWSConstants.ACCESSKEY;

    /** Developer AWS secret key. */
    private static final String secretKey = MWSConstants.SECRETKEY;

    /** The client application name. */
    private static final String appName = MWSConstants.APPNAME;

    /** The client application version. */
    private static final String appVersion = MWSConstants.APPVERSION;

    /**
     * The endpoint for region service and version.
     * ex: serviceURL = MWSEndpoint.NA_PROD.toString();
     */
    private static final String serviceURL = MWSConstants.SERVICEURL;
