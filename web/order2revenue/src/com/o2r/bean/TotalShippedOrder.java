...
public class TotalShippedOrder {
	 ...
	 */
	public static class OrderBySaleQuantity implements
			Comparator<TotalShippedOrder> {

		@Override
		public int compare(TotalShippedOrder ttso1, TotalShippedOrder ttso2) {
			return ttso1.saleQuantity < ttso2.saleQuantity ? 1
					: (ttso1.saleQuantity > ttso2.saleQuantity ? -1 : 0);
		}
	}
	 ...
	 */
	public static class OrderByReturnQuantity implements
			Comparator<TotalShippedOrder> {

		@Override
		public int compare(TotalShippedOrder ttso1, TotalShippedOrder ttso2) {
			return ttso1.returnQuantity < ttso2.returnQuantity ? 1
					: (ttso1.returnQuantity > ttso2.returnQuantity ? -1 : 0);
		}
	}
	 ...
	 */
	public static class OrderByReturnamount implements
			Comparator<TotalShippedOrder> {

		@Override
		public int compare(TotalShippedOrder ttso1, TotalShippedOrder ttso2) {
			return ttso1.returnAmount < ttso2.returnAmount ? 1
					: (ttso1.returnAmount > ttso2.returnAmount ? -1 : 0);
		}
	}
	 ...
	 * Comparator implementation to Sort TSO object based on return amount
	 */
	public static class OrderBySaleamount implements
			Comparator<TotalShippedOrder> {

		@Override
		public int compare(TotalShippedOrder ttso1, TotalShippedOrder ttso2) {
			return ttso1.netSaleAmount < ttso2.netSaleAmount ? 1
					: (ttso1.netSaleAmount > ttso2.netSaleAmount ? -1 : 0);
		}
	}
