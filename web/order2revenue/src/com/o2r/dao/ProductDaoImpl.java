...
public class ProductDaoImpl implements ProductDao {
	...
	List<Product> productlist=null;
		 ...
		 try
		   ...
		   criteria.createAlias("seller", "seller", CriteriaSpecification.LEFT_JOIN)
		   .add(Restrictions.eq("seller.id", sellerId))
		   .add(Restrictions.between("productDate", startDate, endDate))
		   .setResultTransformer(CriteriaSpecification.DISTINCT_ROOT_ENTITY);
		 ...
		 {
			 System.out.println(" Inside find  product by date  exception :"+e.getMessage());
			 e.printStackTrace();
		 }
		return productlist;
			}
	...
	{
		System.out.println(" Inside inventory update method :"+sku+" quantoAdd "+quantoAdd+"quantoSub "+quantoSub);
		...
		try
		{
			...
			System.out.println(" sku after getting from : "+product.getProductSkuCode());
			System.out.println(" Cuurent inventory value : "+product.getQuantity());
		   ...
		   if(product!=null)
		   {
		    System.out.println(" Sku code from procut :"+product.getProductSkuCode());
		   ...
		   System.out.println(" Quantity after merging product object : "+product.getQuantity());
