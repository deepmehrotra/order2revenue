...
public class TaxDetailsDaoImpl implements TaxDetailsDao {
			  ...
			  /* if(criteria.list()!=null&&criteria.list().size()!=0)
			   {
				   ...
				   existingObj=seller.getTaxDetails().get(0);
					  ...
					  if(existingObj.getUploadDate().getMonth()!=taxDetail.getUploadDate().getMonth())
					   ...
					   else if(existingObj.getUploadDate().getMonth()==taxDetail.getUploadDate().getMonth())
					   {
			   ...
			   if(criteria.list()!=null&&criteria.list().size()!=0)
			   {
				   ...
				   existingObj=seller.getTaxDetails().get(0);
					  ...
					  if(existingObj.getUploadDate().getMonth()!=taxDetail.getUploadDate().getMonth())
					   {
						   taxDetail.setStatus("Due");
						   taxDetail.setDescription("TDS for "+formatter.format(taxDetail.getUploadDate()));
 ...
 public void addPaymentTaxDetail(TaxDetail taxDetail , int sellerId) throws CustomException
 {
	 ...
	 log.debug("addPaymentTaxDetail : cat : "+taxDetail.getParticular()+" Amoun :"+taxDetail.getBalanceRemaining());
		TaxDetail existingObj=null;
		Date todaysDate=new Date();
		  ...
		  try
		   {
		    ...
		    session.getTransaction().commit();
		  	session.close();
			   ...
			   log.error(e);
		throw new CustomException(GlobalConstant.addTaxPaymentDetailError, new Date(),1,sellerId+"-"+GlobalConstant.addTaxPaymentDetailErrorCode, e);
 ...
 public void addStatusTDSDetail(TaxDetail taxDetail , int sellerId) throws CustomException
 {
	 ...
	 log.debug("addStatusTDSDetail : cat : "+taxDetail.getParticular()+" Amount :"+taxDetail.getBalanceRemaining());
		TaxDetail existingObj=null;
		Date todaysDate=new Date();
		  ...
		  try
		   {
		    ...
		    session.getTransaction().commit();
		  	session.close();
			   ...
			   log.error(e);
		throw new CustomException(GlobalConstant.addTDSPaymentDetailError, new Date(),1,sellerId+"-"+GlobalConstant.addTDSPaymentDetailErrorCode, e);
...
//Tax Categoyr Implementation
 ...
 public TaxCategory addTaxCategory(TaxCategory taxCategory , int sellerId) throws CustomException
 {
	 ...
	 log.debug("addTaxCategory : cat : "+taxCategory.getTaxCatName()+" Amount :"+taxCategory.getTaxPercent());
		Seller seller=null;
		  try
		   {
			   Session session=sessionFactory.openSession();
		   ...
		   session.close();
			   ...
			   log.error(e);
		throw new CustomException(GlobalConstant.getTaxDetailListError, new Date(),1,sellerId+"-"+GlobalConstant.getTaxDetailListErrorCode, e);
	 ...
	 log.info("***listTaxDetails Start****");
		...
		catch(Exception e)
		{
			 log.equals("**Error Code : "+(sellerId+"-"+GlobalConstant.getTaxDetailListErrorCode2));
			   log.error(e);
		throw new CustomException(GlobalConstant.getTaxDetailListError, new Date(),1,sellerId+"-"+GlobalConstant.getTaxDetailListErrorCode2, e);
	 ...
	 log.info("***listTaxDetails Start****");
		...
		catch(Exception e)
		{
			log.equals("**Error Code : "+(sellerId+"-"+GlobalConstant.getTaxCatListErrorCode));
			   log.error(e);
		throw new CustomException(GlobalConstant.getTaxCatListError, new Date(),1,sellerId+"-"+GlobalConstant.getTaxCatListErrorCode, e);
	 ...
	 log.info("***getTaxCategory Start*****"+catName);
	   ...
	   session.close();
			 ...
			 log.equals("**Error Code : "+(sellerId+"-"+GlobalConstant.getTaxCategoryErrorCode));
			   log.error(e);
		throw new CustomException(GlobalConstant.getTaxCategoryError, new Date(),1,sellerId+"-"+GlobalConstant.getTaxCategoryErrorCode, e);
 ...
 public void deleteTaxCategory(TaxCategory taxCategory,int sellerId) throws CustomException
 {
	 ...
	 catch(Exception e)
	 {
		 log.equals("**Error Code : "+(sellerId+"-"+GlobalConstant.deleteTaxCategoryErrorCode));
		   log.error(e);
	throw new CustomException(GlobalConstant.deleteTaxCategoryError, new Date(),1,sellerId+"-"+GlobalConstant.deleteTaxCategoryErrorCode, e);
