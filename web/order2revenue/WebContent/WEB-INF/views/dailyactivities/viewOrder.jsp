                        ...
                        <div class="ibox-content add-company view-order">
                          ...
                          <div class="table-format-wrapper three-data-width">
							  ...
							  <div>
                                  ...
                                  <span></span>
                                  <span>${order.orderPayment.positiveAmount}</span>
                              </div>
							   <div>
                        ...
                        <div class="ibox-content add-company view-order">
                          ...
                          <div class="table-format-wrapper three-data-width">
                              ...
                              <div>
                                  ...
                                  <span></span>
                                  <span><fmt:formatDate value="${order.returnLimitCrossed}" pattern="MMM dd,YY"/></span>
                              </div>
                              <div>
                                  <span>RTO Limit</span>
                                  <span></span>
                                  <span><fmt:formatDate value="${order.rTOLimitCrossed}" pattern="MMM dd,YY"/></span>
                              </div>
							  <div>
                                  <span>Return Date</span>
                                  <span></span>
                                  <span><fmt:formatDate value="${order.orderReturnOrRTO.returnDate}" pattern="MMM dd,YY"/></span>
                              </div>
							 <div>
