			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content overflow-h">
					<form:form method="POST" action="saveManualPayment.html"
						id="addManualPaymentForm" role="form" class="form-horizontal">
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								...
								<div class="mar-btm-20-dt">
									<label class="col-sm-5 control-label">Date of Payment</label>
									<div class="col-md-7" id="data_1">
										<div class="input-group date">
											<span class="input-group-addon"><i
												class="fa fa-calendar"></i> </span>
											<form:input id="my" path="orderPayment.dateofPayment"
								...
								<div class="mar-btm-20-dt">
									<label class="col-sm-5 control-label">Negative Amount</label>
									<div class="col-sm-7">
										<form:input path="orderPayment.negativeAmount"
											value="${order.orderPayment.negativeAmount}"
											class="form-control" />
									</div>
								</div>
								<div class="mar-btm-20-dt">
