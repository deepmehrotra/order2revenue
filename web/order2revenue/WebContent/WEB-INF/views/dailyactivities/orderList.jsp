                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Orders(${orders.size()})</h5>
                             <div class="table-menu-links">
                                <a href="#"   id="POOrders">PO Orders</a>
                            ...
                            <div class="ibox-tools">
                              <button class="btn btn-white table-menu-search search-dd">
                                ...
                                <div class="search-more-wrp">
                                    <form role="search" class="form-inline" method="post" action="searchOrder.html">
                                        <div class="form-group">
                                            <select class="form-control" name="searchOrder"  id="searchOrder">
                                                <option value="searchchannelOrderID">Channel OrderId</option>
                                                <option value="SearchorderDate">Order Date</option>
                                            </select>
                                        </div>
                                        <div class="form-group OrderSearch-box" id="searchchannelOrderID">
                                           <input type="text" placeholder="Enter Channel OrderID" class="form-control" name="channelOrderID">
                                        </div>
                                        <div class="form-group OrderSearch-box" id="SearchorderDate" style="display:none">
                                ...
                                <button type="button"  id="LoadMoreOrder" class="btn btn-xs btn-white">More</button>
                        ...
                        <div class="scroll-y">
                           <c:if test="${!empty savedOrder}">
                      		 <h2 style="font-weight: bold">Your order ${savedOrder} is saved successfully.</h2>
                         	</c:if>
