...
<script type="text/javascript">
    function submitOrder(){
        ...
        function varify(){
            ...
            reqObj.open("GET","checkOrder.html?id="+document.getElementById("test").value,true);
            reqObj.send(null);
        }
        function process(){
 ...
 <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <form:form method="POST" action="saveOrderDA.html"
                            ...
                            <div id="tab-1" class="tab-pane active col-sm-12">
                                <div class="col-sm-6">
                                   <div class="mar-btm-20-oh"><label class="col-sm-5 control-label">Order ID/PO No</label>
                                    ...
                                    class="form-control" id="test" onblur="varify();"/><span id="res"></span></div>
                                    </div>
