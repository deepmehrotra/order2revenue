...
<head>
  ...
  <script src="https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script> -->
	...
	<script src="/landing/js/jquery-1.9.1.min.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js"></script>
    <script src="/landing/js/bootstrap.min.js"></script>
...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:#fff;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/landing/home.html" style="margin-top: -15px;"><img src="/landing/img/bluelogo.png" class="img-responsive" alt="logo" width="60" height="46"></a>
        ...
        <ul class="nav navbar-nav" style="float: right;">
          <li>
            <form action="#" class="form">
              <input type="text" placeholder="Enter keywords to search" class="filterinput form-control" id="text-search" data-filter="true" data-type="accordion-search" />
            </form>
          </li>
...
<div id="section1" class="container-fluid">
      ...
      <div class="col-lg-3">
        ...
        <div class="col-md-12">
            <div class="column listitem">
              ...
              PO Orders</a>
              <br>
                <a href="#" title="is the unique reference ID associated with an Order or Purchase Order. Mostly Order ID is used to identify or search for an Order. 
                ...
                ">Order ID/PO ID</a>
                <br>
                <a href="#" title="is the return reference ID associated with Sale Returns of MP Orders and is mostly provided by the Sales Channel. In case the same is not provided. The seller can input their own desired unique value to further identify the Order.">Return RTO/ID</a>
                <br>
                <a href="#" title="is the unique reference ID associated with Sale Returns of PO Channels such as Myntra and jabong.">Gate pass Id</a>
                <br>
                <a href="#" title="is Snapdeal’s Unique Order Attribute for identifying an Order.">Sub Order ID </a>
                <br>
                <a href="#" title="is Unique Order Attribute for identifying an Order for Flipkart and Paytm">Unique Item ID </a>
                <br>
                <a href="#" title="is Snapdeal’s another reference Order Attribute for identifying an Order.">PI Reference No </a>
                <br>
                <a href="#" title="Invoice ID is the unique ID provided by the seller against every Sale, Transaction or Order.">Invoice ID </a>
                <br>
                <a href="#" title="is the Airway Bill No of a shipment and is used to track the status of a shipment. The same may or may not be unique depending on Sales Channel.">AWB </a>
                <br>
                <a href="#" title="are Return to Origin Shipments which were never delivered to the buyer for reasons like customer not present, customer denied delivery etc.">RTO</a> 
                <br>
               <a href="#" title="">PI Reference Number</a> 
               <br>
               <a href="#" title="">Flipkart Unique Item ID</a> 
               <br>
               <a href="#" title="or Shipping Partner is the carrier which is being used to transport or deliver the shipment. Generally, every sales channel uses multiple Logistic Partners to deliver its shipments.">Logistic Partner</a> <br>
               <a href="#" title=":is the date on which an order is shipped by the seller.">Order Shipped Dtae</a> <br>
               <a href="#" title="is the date on which an order was received by the seller.">Order Received Dtae</a> 
               <br>
               <a href="#" title="is the date on which an order is expected to be delivered to the customer.">Estimated Delivery Dtae</a>
               <br> 
               <a href="#" title="are the transportation charges that the seller needs to pay for delivery of an order to the customer. The shipping charges are usually calculated on the basis of Dead Weight or Volumetric Weight of a product and their delivery zones.">Shipping Charges
               </a>
               <br>
               <a href="#" title="">Additional Shipping Charges </a><br>
               <a href="#" title="">Customer Discount </a><br>
               <a href="#" title="">EOSS Discount</a><br> 
               <a href="#" title="is the date on which a Return/RTO order is received by the seller irrespective of the date on which the order was picked from the customer">Return/Rto Date</a> <br>
               <a href="#" title="">Return Charges</a> <br>
               <a href="#" title="is the quantity of an order that has been returned to the seller for any reason.">Return Qty</a> <br>
               <a href="#" title="">Return Reason</a> <br>
               <a href="#" title="">RTO Acceptance Period</a><br>
               <a href="#" title="is the amount that the seller is due to be paid, for selling a product via a sales channel, irrespective of the quantity of the order. In other words net N/R is 
                Gross N/R * Qty.">Net N/R(Net Receivable)</a><br>
            </div>
        </div>
      </div>
      <div class="col-lg-3">
        ...
        <div class="column listitem">
          <a href="#" title="is a categorized, Sales Channel agreed, timelines that will be used to record and reconcile transactions between a specific period. For example, the transaction that will happen between 1st Apr 2015 – 30th April 2015 will be paid for on 15th May 2015.">Payment Cycle</a>
          <br>
          <a href="#" title="is the date on which the payment of an order is expected to physically arrive at the seller.">Estimated Date of Payment</a> <br>
          <a href="#" title="is the date on which the payment of an order has physically arrived at the Seller.">Actual Date of Payment</a><br> 
          <a href="#" title="describes how a customer has paid for an Order. Typically, there are 2 kinds of Payment Type- Prepaid or COD. Prepaid is when a customer has made the payment and the product is shipped post the payment has been received by the Sales Channel. Whereas in COD Orders, the customer pays for the product at the time of delivery of the product.">Payment Type</a><br> 
          <a href="#" title="">Payment Differnce Amount</a> <br>
          <a href="#" title="">A/R,A/R1,A/R2</a> <br>
          <a href="#" title="">Net Payment Received</a> <br>
          <a href="#" title="is the net result of all financial transactions of an order during its complete life. ">Net Payment Result</a> <br>
          <a href="#" title="is the N/R value of an order that will be revered, as a result of receiving a sale return. Plz note that the sellers are expected to state Return Type, Return Stage and Fault Type during return input.">Gross Return Charges: </a><br>

          <a href="#" title="">Gross P/R</a> <br>
          <a href="#" title="Pure Receivable) is the tax free amount of an order that the seller will physically receive against the sale of an order. P/R is “tax free N/R”.">P/R</a> <br>
          <a href="#" title="is the maximum retail price on which a product can be sold.">MRP</a> <br>
          <a href="#" title="is the selling price of a product. This is the amount that a customer has paid to purchase the product from the Sales Channel. The SP of a product may or may not be equal to MRP. In case the seller has provided the customer with a discount, SP and MRP would differ. Plz Note that SP of a product includes the following
          ...
          ">SP</a><br>
          <a href="#" title="is the amount that the seller is due to be paid, for selling 1 quantity of a product via any sales channel.">GROSS N/R</a> <br>
          <a href="#" title="">NET N/R</a> <br>
          <a href="#" title=": is the final quantity of an order that been sold. It might be “0” in certain cases for example, if an order consisted of, Gross Qty = 1, and the same was returned to the seller, the Net Sale Qty will be = 0.">Net Sale Qty</a> <br>
          <a href="#" title="is the quantity of a product that has been sold in an order. This may or may not be same as “Net Sale Qty”. In case a sold order is returned to the seller for any reason, the Net Sale Qty will differ from Gross Sale Qty. ">Gross Sale Qty</a><br> 
          <a href="#" title=": is the net sales of the business on which tax liability stands due. For MP Channels, the sales channels only show themselves as an intermediary hence the liability of depositing sales tax on Selling price of the product stays with the Seller.
          ...
          ">Net Taxable Sale </a> <br>
          <a href="#" title="is the actual sales of the business. These are the figures that should ideally be received by the seller against sales of his/her products via any sales channels. 
          ...
          ">Net Actual Sale</a><br>
          <a href="#" title="is the total sale value of the business in the concerned time period. Gross Sale is taken into account on the basis of SP’s for sales channels who have TDS as applicable, and on the basis of PO Price for sales channels without having TDS as applicable. TDS applicable settings can be structured during Sales Channel configuration. Plz note Sale Return is not deducted from the Sale Return.">Gross Sale</a> <br>
           <a href="#" title="is the total net sale value of the business in the concerned time period. Net Sale is the taxable sale value of the business after deducting Sale Return Values from the Gross Sale Values. Plz note that tax to be deposited by the seller is calculated on the basis of Net Sale.">Net sale</a><br>
           <a href="#" title="is a sale order which has been returned by the customer with or without any reason. There are 2 kinds of Sale Return – “Return” and “RTO”. Return is an order which has been returned by the customer after the product was delivered to the customer and the customer was for some reason did not want the product. Whereas RTO is an order which was returned as it could not reach the customer for any reason like pin-code not available, customer not present, fake order etc.">Net Return</a><br>
           <a href="#" title="is the total representation of net profits from the sale of products during the concerned period."> Income</a><br>
           <a href="#" title="">Net Income</a><br>
          <a href="#" title="">Gross Profit </a> <br> 
          <a href="#" title=":is the price that the seller will be paid by the Sales Channel against any transaction. TP may or may not be equal to Gross or Net N/R of an order depending on the conditions. For TP Channels the N/R Switch needs to be turned off. And the seller is required to input TP value of the order during order input">Transfer Price(TP) </a><br>
          <a href="#" title="is the amount that the seller is due to be paid, for selling a product via a sales channel, irrespective of the quantity of the order. In other words net N/R is 
          Gross N/R * Qty. 
          ">Net N/R(Net Receivable) </a><br>
          <a href="#" title="is the direct commission paid to Sales Channel for selling a product. Plz note that sales channels always charge commissions on total SP">Gross Selling Commission </a>
          <a href="#" title="is paid to Sales Channels for selling a product is directly dependent on selling price of a product. Plz note that sales channels always charge commissions on total SP.">Fixed Fee</a><br>
          <a href="#" title="">Net Profit</a>

        </div>
      </div>
      <div class="col-lg-3">
        <h3 class="heading">Product Related</h3>
         <div class="subcolumn listitem">
          <a href="#" title=": is created to categorize products and generate informative category wise reports to assess and compare the performance of each product category.">Product Category</a>
          <br> 
            <a href="#" title="is created to further sub categorize products and generate informative group wise reports to assess and compare the performance of each inventory group within a Product Category.">Inventory Group</a> <br>
            <a href="#" title="is a unique Product that the seller has to offer. SKU is unique product ID created by the seller to identify their Offerings.">SKU </a><br>
            <a href="#" title="is the direct landed cost of a product to the seller.Generally, this is the amount which the seller has invested to buy or manufacture a product."> Cost Of Product </a>
            <br>
            <a href="#" title="are taken from customer for collecting payments on seller’s behalf.  ">Payment Collection Charges(PCC) </a><br>
              <a href="#">Inventory Thresold Limit</a><br>
         </div>
         <h3 class="heading">Channel Related</h3>
          <div class="subcolumn listitem">
            <a href="#" title="or Selling Partners are the online Webstores on which a seller is selling their Products.For example,Snapdeal,Amazon,Flipkart are all Sales Channels">Sales Channel</a><br>
            <a href="" title="determines whether the Sale Return is due to Seller Fault or Buyer Fault or Return. This needs to be stated during Return Input.">Fault Type</a><br>
            <a href="" title="is the positive or credit transaction received from Sales Channel against an order/shipment.">Payment Positive Amount</a><br>
            <a href="" title="is the negative or debit transaction received from Sales Channel against an order/shipment.">Payment Negative Amount:</a><br>
            <a href="" title="is the difference amount of MRP and SP of a product.This is the discount that the seller has offered to the customer as part of a lucrative deal to purchase the product.">Customer Discount </a><br>
            <a href="#" title="is Myntra specific. EOSS Discount value is the difference between the “PO Price” and “Net Receivable(N/R)” of a Product. Generally at the end of every payment cycle, myntra debits sellers with an EOSS Discount amount that was extended to the customer as customer discount. ">EOSS Discount </a><br>
            <a href="#" title="is created to distinguish sales between different sales tax rates depending on local government policies, regulations, tax rates and products categories. The seller is requested to responsibly configure tax categories as the same will derive the accuracy of TAX and TDS dues as per their local government regulations and expectations">Tax Category</a><br>
            <a href="#" title="is the tax liability of the seller for the selected period. This is the amount that is to be deposited by the seller, to the government as tax dues for the concerned period. This amount is calculated on the basis of net sale of the seller.">Net Tax to be deposited </a><br>
            <a href="#" title="is the tax amount that is reversed (debited from the total tax liability) as a result of Sale Return.">Tax Amount Reversed </a><br>
            <a href="#" title="is the TDS(Tax deducted at source) liability of the seller for the selected period. This amount is to be deposited by the seller, to the government, as TDS dues for the concerned period. Plz note that this amount is later reimbursed back from Sales Channels by presenting them with TDS certificates. Plz note that this may or may not be applicable to your business depending on your local government policies and regulations. Plz check with concerned authorities for better understanding. 
            Plz Note that Net TDS liability is calculated on Net Sale only.
            ">Net TDS to be deposited </a><br>
            <a href="#" title=": is the TDS amount that is reversed (debited from the total TDS liability) as a result of Sale Return.">TDS reversed </a><br>
            <a href="#" title="is the amount paid to Sales Channels as part of agreed commissions on account of Sales made via the Sales Channels.">Gross Partner Commission Paid </a>
            <a href="#" title="is the net amount paid to Sales Channels after considering sale and return of an order.">Net Channel Commission Paid </a><br>
            <a href="#" title="is Myntra specific. Turn Over Incentive is charged by Myntra from sellers based on the turnover provided by Myntra to the seller in a financial year. The frequency of TOI depends on contract to contract. Plz note that TOI is over and abover the commissions charged on monthly basis. ">TOI(Turn-Over Incentive) </a><br>
            <a href="#" title="is an O2R generated ID used to track payments. Plz Note in order to input manual charges the seller needs to mention the respective payment ID to link it to the transactions">Payment ID : </a><br>
            <a href="#" title="is the current financial status of your order/transaction. If this is “negative”, then that amount is still pending to be received from the Sales Channel. Whereas if “positive”, then that amount is still to be paid to the Sales Channel">Payment Difference Amount </a><br>
            <a href="#" title="can be used to input any manual comments/notes into any order for any kind of references later.">Seller Notes </a><br>
            <a href="#" title="describes the reason associated to a Sale Return. This may or may not be available at all instances. The mentioned reasons can be used for further improvising of products.">Return Reason </a><br>
            <a href="#" title="is the gross profitability of the business in the concerned time period. Plz note that Gross Profits are always derived at the core level wherein revenues are only compared with Direct product costs, and other important ”business related expenditures” are still to be deducted. The mentioned other “business related expenditures” are deducted while calculating Net Profit. ">Gross Profit : </a><br>
            <a href="#" title="is the net profitability of the business in the concerned time period. Net Profit is the amount earned from a transaction after deducting all expenses. The sellers are requested to input expenses sincerely for accurate results. The amount displayed as Net profits will only be estimations based on the data provided by the seller. Plz note that as per basic accounting principles “Assets” Expense Category is ignored from calculating Net Profits.">Net Profit  </a><br>
            <a href="#" title="are the expenditures that a business invests, in order to operate the business. Input all kinds of expenses ranging from Tax Payments, Production/Sourcing payments, Petty expenses, Salaries etc for most effective data results.">Expenses </a><br>
            <a href="#" title="The expenses can be categorized into groups for better understanding insights of the business’s expenditures.">Expenses Category </a><br>
            <a href="#" title="is the opening financial value of the Inhouse available stock, at the beginning of the concerned period. Plz note that the valuation of stock will be highly dependent on the inventory data provided by the seller to O2R.">Opening Stock Valuation : </a><br>
            <a href="#" title="is the closing financial value of the Inhouse available stock, at the end of the concerned period. Plz note that the valuation of stock will be highly dependent on the inventory data provided by the seller to O2R.">Closing Stock Valuation : </a><br>
            <a href="#" title=": can be structured by the seller to receive alerts as and when the inventory level of a product approaches its threshold limit. These can be structured within SKU’s.">Inventory Threshold Limit</a><br>
            <a href="#" title="can be used as shortcodes to be used during everyday input of data, by associating with available attributes.">Alias Name </a><br>
            <a href="#" title="are the SKU’s as represented across different Sales Channels. In other words Mapping SKU’s across different Sales Channels with an Original SKU. This is a non-mandatory attribute and can be used as a great tool, helpful during “Sale Return” Input. (O2R’s Universal Search Capabilities)">Channel Mapping names</a><br>
            <a href="#" title="is the period agreed with Sales Channel for accepting products as Sale Return from the date of its shipping or delivery. Separate Acceptable limits can be structured for Return’s or RTO’s. in case an order is received post its discussed acceptable limit. The sale will be notified to the seller.">Return/RTO Acceptance Period </a><br>
            <a href="#" title="is the current status of an order/transaction. For better understanding plz visit the following link: hyperlink to Guidelines."> Status </a><br>
            <a href="#" title="is the current decisive status of an order/transaction. There are 2 possible Actions- “Settled” or “Actionable”. If an order is “Settled”, the complete amount against the concerned order has been received and no further action is required on the same order from the seller. Whereas if it is “Actionable“, than an action is advised to the seller to recover the Payment Difference Amount from the Sales Channel against the concerned order.">Action </a><br>
            <a href="#" title="are the charges, chargebacks, penalties, stock-out commissions, delay in dispatch penalties, packaging material charges, product listing ads charges, incentives and any other kind of charges that a seller is charged at the end of any payment cycle. Plz note such charges should not be uploaded with the Payment Summaries but rather should be separated and uploaded at Manual Charges section.">Manual Charges </a><br>
            <a href="#" title="An event is a special sale or promotion by the Sales Channels to temporarily aggravate its product sales. Usually during a big event the commercials arrangement differ between Seller and Sales Channels. For example, Flipkart’s Big Billion Day, Myntra’s End of Season Sale. 
            Plz note Events @ O2R is a tool for sellers to configure their temporary commercial arrangements without affecting their original configurations.
            ">Events </a><br>
            <a href="#" title="is the automated organized database generated by O2R for sellers based on input strings. ">Customer Database : </a><br>
            <a href="#" title="are possible fraud customers who intend to deplete competitor seller ratings and only buy a product with the motive of returning it. O2R bot collects information about such customers and puts them in the list of blacklisted customers.">Blacklisted Customers </a>
            <a href="#" title="Universal Search Bar is one stop search solution to track any order based on any attribute of the order including customer name, location, pincode, phone no.">Universal Search Bar </a><br>
         </div>
      </div>
     <div class="col-lg-3">
        <h3 class="heading">General</h3>
          <div class="subcolumn listitem">
          <a href="#" title="">Product Category</a> <br>
            <a href="#" title="">Inventory Group</a> <br>
            <a href="#">Cost Of Product </a><br>
            <a href="#" title="is the opening financial value of the Inhouse available stock, at the beginning of the concerned period. Plz note that the valuation of stock will be highly dependent on the inventory data provided by the seller to O2R.">Opening Stock Valuation </a><br>
            <a href="#" title=": is the closing financial value of the Inhouse available stock, at the end of the concerned period. Plz note that the valuation of stock will be highly dependent on the inventory data provided by the seller to O2R.">Closing Stock Valuation </a><br>
           
            <a href="#" title="can be structured by the seller to receive alerts as and when the inventory level of a product approaches its threshold limit. These can be structured within SKU’s.">Inventory Thresold Limit</a><br>
         </div>
         <h3 class="heading">TAX/TDS Related</h3>
         <div class="subcolumn listitem">
            <a href="#" title="">Tax Category</a><br> 
            <a href="#" title="">Tax amount to be deposited</a> <br>
            <a href="#" title="">Tax amount Reversed </a><br>
            <a href="#" title="">Net Partner Commission Paid </a><br>
            <a href="#" title="">TDS To Be Deposited</a><br>
            <a href="#" title="">Net Partner Commission Paid </a><br>
            <a href="#" title="">TDS Reversed</a><br>
            <a href="#" title=": is the tax charged by Sales Channels on the total commissions collected from Sellers. Service tax is only calculated on MP Channels. PO Channels do not charge Service Tax
            Plz note that Service tax may or may not be included in the commission percentages. Kindly clarify with sales channels and in cases when service tax in inclusive the sellers are required to mention net commission and service tax rates separately while configuring a sales channel.
            ">Service Tax</a><br>

            <a href="#" title=": is the tax charged by Sales Channels on the total commissions collected from Sellers. Service tax is only calculated on MP Channels. PO Channels do not charge Service Tax
            Plz note that Service tax may or may not be included in the commission percentages. Kindly clarify with sales channels and in cases when service tax in inclusive the sellers are required to mention net commission and service tax rates separately while configuring a sales channel.
            ">Tax(PO Price)</a><br>
            <a href="#" title=": is the tax collected by Sales Channels from Sellers on account of the tax that they will be liable to pay on sale of the product to the customer. Plz note that this is only applicable in cases of PO channels.">Tax(sp)</a><br>
            <a href="#" title="is the amount that the seller has physically received from the sales channel against selling a product. An order might be debited or credited several on several durations during its life. Every debit or credit transaction is recorded as A/R.">A/R(Actual Received)</a><br>
            <a href="#" title="is the amount that the seller is liable to pay to the sales channels on account of a sale return. These charges are completely dependent on the sellers agreement with Sales Channel.">Additional Return Charges </a><br>
            <a href="#" title="Customer Return is a sale return which comes after successful delivery of an order and does not fall under any other classification. For example, Returns due to size, color, product quality, customer remorse.">Return</a><br>
            <a href="#" title="Any order which has been cancelled by the buyer or seller for any reason.">Cancellation Return</a><br>
            <a href="#" title="Any order which was partly delivered to the buyer. For example, a customer ordered “1 Bean Bag Cover with Beans” but only received the Bean Bag Cover and returned the product.">Partial Delivery Return</a><br>
            <a href="#" title="are any sale returns for which the seller is required to ship a replacement.">Replacement Return</a><br>
            <a href="#" title="determines whether the Cancelled Sale Return was cancelled before marking it Ready to Dispatch or After marking it Ready to dispatch. This needs to be stated during return input.">Return Stage </a>
         </div>
      </div>     
  </div>
</div>
            ...
            <div class="panel-group" id="accordion1">
                  ...
                  <div class="panel-body">
                    <div class="col-sm-12 wow fadeInRight animated">
                      <a  class="heading" href="#">
                        ...
                        1.  Visit ”Daily Activities” Icon on the tool bar.<br>
                        ...
                        4.  Input details in the excel sheet. Upload the sheet by clicking on Upload Button.
                        </a>
                        <br>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseOne1-b" class="panel-collapse collapse">
                  <div class="panel-body">
                    <div class="col-sm-12 wow fadeInRight animated listitem">
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseOne4-d" class="panel-collapse collapse">
                  <div class="panel-body">
                    <div class="col-sm-12 wow fadeInRight animated listitem">
                              <a href="#"  class="heading">
                                Manual Charges(both positive and negative) consist of all charges that are not directly associated with an original order.The below mentioned charges need to be separated from a payment summary manually by the seller.
                                </a>
                                <br>
                                <div class="col-lg-6">
        ...
        <div id="collapseFive" class="panel-collapse collapse">
          <div class="panel-body">
            <div class="panel-group" id="accordion5">
              ...
              <div class="panel panel-default">
                <div class="panel-heading listitem">
                  <h5 class="panel-title">
                ...
                <div class="panel panel-default">
                  ...
                  <div id="collapseOne11-a" class="panel-collapse collapse">
                    <div class="panel-body">
                      <div class="col-sm-12 wow fadeInRight animated listitem">
                                <a href="#"  class="heading">
                                  O2R data is a mere reflection of statistics derived from the inputs provided by the Seller.Based on the input strings O2R provides 100 percent accurate information.
                                </a>
                      </div>
                    </div>
                  </div>
  ...
  <div class="col-lg-3" style="margin-top: 50px;">
    <img src="/landing/img/faq.png" alt="faq" width="90" style="float: right;margin-top: 58%;">
  </div>
</div>
<div id="section3" class="container-fluid">
      ...
      <div class="listitem">
        <a href="#" class="paragraph">
          α All Orders to be accounted in the period, events related to them happen.For example if a Return comes in Period Y and the order was due in Period
             then it should be calculated in Period Y only and not in Period X.It will be used in Period X only in the net due amount.</a>
      </div>
      <div class="listitem">
        <a href="#" class="paragraph">
  ...
  <div class="col-lg-3">
    <img src="/landing/img/guide.png" alt="guide" width="90" style="float: right;margin-top: 20%;">
  </div>  
</div>
<div id="section41" class="container-fluid">
  ...
  <div class="col-lg-12">
    <div class="col-lg-3">
      <img src="/landing/img/setting.png" alt="setting" width="292" class="img-responsive">
    </div>
    <div class="col-lg-9">
      <div class="col-md-12 leftmargin">
        <div class="col-md-3">
            <img src="/landing/img/curve.png" alt="curve" style="width: 92px;position: relative;left: 156px;top: -19px;z-index: 9;">
        </div>
        <div class="col-md-9" style="padding:0px;">
          <div class="listitem">
            <a href="#" class="btn btn-red btn-block" id="butonn24">Configure Product Categories</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn1">Configure Inventory Groups</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn2">Configure SKU's</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn3">Configure Tax Categories</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn4">Configure Expense Groups</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn5">Configure Sales Channels</a>
          </div>
        </div>
      </div>
    </div>
...
<div id="section42" class="container-fluid" style="background-color: #ffffff;">
  ...
  <div class="col-lg-12">
    <div class="col-lg-3">
        <img src="/landing/img/dailyact.png" alt="dailyactivities" width="292" class="img-responsive">
    </div>
    <div class="col-lg-9">
      <div class="col-md-12 leftmargin">
        <div class="col-md-3">
            <img src="/landing/img/curve.png" alt="curve" style="width: 92px;position: relative;
            left: 157px;top: -19px;z-index: 9;">
        </div>
        <div class="col-md-9">
          <div class="listitem">
            <a href="#" class="btn btn-block" id="butonninput">Input Orders</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-block" id="butonn10" >Input Sale Returns</a>
          </div>
          <br>
          <div class="listitem">
            <a href="#" class="btn btn-red btn-block" id="butonn13" >Input Payments</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn16">Input Manual Charges</a>
          </div>
          <br>
          <div class="listitem">
            <a href="#" class="btn btn-red btn-block" id="butonn18">Input Inventories</a>
          </div>
          <br>
          <div class="listitem">
            <a href="#" class="btn btn-red btn-block" id="butonn19">Input Expenses</a>
          </div>
        </div>
      </div>
    </div>
...
<div id="section43" class="container-fluid" style="background-color: #fff;">
  ...
  <div class="col-lg-12">
    <div class="col-lg-3">
        <img src="/landing/img/report.png" alt="report" width="292" class="img-responsive">
    </div>
    <div class="col-lg-9">
      <div class="col-md-12 leftmargin">
        <div class="col-md-3">
            <img src="/landing/img/curve1.png" alt="curve1" style="width:104px;position: relative;left: 157px;top: -17px;z-index: 9;">
        </div>
        <div class="col-md-9">
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn22">Order Related Report</a>
          </div>
          <br>
          <div class="listitem">
            <a href="#" class="btn btn-red btn-block" id="butonn11">Taxation Reports</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn14">Channel Related Reports</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn7">Expense Related Reports</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn8">Inventory Related Reports</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn9" >General Reports</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn6">Revenue Related Reports</a>
          </div>
        </div>
      </div>
    </div>
...
<div id="section44" class="container-fluid" style="background-color: #fff;">
  ...
  <div class="col-lg-12">
    <div class="col-lg-3">
        <img src="/landing/img/misscellaneous.png" alt="misscellaneous" width="292" class="img-responsive">
    </div>
    <div class="col-lg-9">
      <div class="col-md-12 leftmargin">
        <div class="col-md-3">
            <img src="/landing/img/curve.png" alt="curve" style="width: 92px;position: relative;left: 158px;top: -19px;z-index:9;">
        </div>
        <div class="col-md-9">
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn23">Understanding Tax/TDS</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn12">Configure Events</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn15">Configure Expected Delivery Time</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn17">Undestanding Customer Database</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn21">Using Universal Search</a>
          </div>
          <br>
          <div class="listitem">
          <a href="#" class="btn btn-red btn-block" id="butonn20">Understanding Dashboard</a>
          </div>
        </div>
      </div>
    </div>
...
<script>
      (function ($) {
        ...
        function live_search(item) {
          $(".filterinput")
            .change( function () {
              var searchtext = $(this).val();
              if(searchtext) {
                $matches = $(item).find('a:Contains(' + searchtext + ')').parent();
                $('.listitem', item).not($matches).slideUp();
                $matches.slideDown();
              } else {
                $(item).find(".listitem").slideDown(200);
              }
              return false;
            })
          .keyup( function () {
