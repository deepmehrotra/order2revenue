	...
	<div class="row border-bottom">
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle count-info"
				...
				style="padding: 0px; min-height: 0px; position: relative; top: 1px;"
				onclick="Alerts();"> <i class="fa fa-bell" id="bellimg"
					style="font-size: 16px; color: #1ab394; padding: 3px; margin: 0px 7px 0px 2px;" aria-hidden="true"></i> <span id="spanid"
					style="position: relative; right: 26px; color: #fff; font-size: 9px; top: -3px;"></span>
			</a>
