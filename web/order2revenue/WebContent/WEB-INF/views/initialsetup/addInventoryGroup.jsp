...
<div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <form:form method="POST" action="saveInventoryGroup.html" id="addInventoryGroupForm"
                         ...
                         <input type="hidden" name="id" id="id" value="${category.id}"/>
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-7">
                                    <form:input path="catName" value="${category.catName}"  class="form-control" id="categoryName" onblur="checkOnBlur()"/>
