					...
					class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                        	<div class="radio">
                                            <label> <form:radiobutton path="nrnReturnConfig.commissionType" value="fixed"
                                        ...
                                        <div class="col-sm-4">
                                        	<div class="radio">
                                            <label> <form:radiobutton path="nrnReturnConfig.commissionType"	value="categoryWise"
															id="5" class="commissionType" name="toggler" onChange="handleRadioEvent(this);"/>
													CATEGORY WISE
											</label>
											</div>
                                        </div>
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-4">
								<div class="radio">
									<label> <form:radiobutton path="nrnReturnConfig.taxSpType" value="fixed"
							...
							<div class="col-sm-4">
								<div class="radio">
									<label> <form:radiobutton path="nrnReturnConfig.taxSpType"	value="categoryWise"
															id="7" class="taxSpType" name="toggler" onChange="handleRadioEvent(this);"/> CATEGORY WISE
									</label>
								</div>
							</div>
