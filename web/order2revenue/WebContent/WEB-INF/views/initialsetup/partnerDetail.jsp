...
<script type="text/javascript">
    function onclickeditpartner(id) {
    	$.ajax({
            url : 'editPartner.html?pcId='+id,
                            ...
                            <table class="table table-bordered custom-table">
                                ...
                                <tr>
                                   ...
                                   <td class="tooltip-demo"> 
                                    <a href="#"  onclick="onclickeditpartner('${partner.pcId})"><i class="fa fa-edit text-navy" data-toggle="tooltip" data-placement="top" data-original-title="Edit"></i></a></td>
                                 </tr>
                               </c:forEach>
                                </tbody>
                            </table>
