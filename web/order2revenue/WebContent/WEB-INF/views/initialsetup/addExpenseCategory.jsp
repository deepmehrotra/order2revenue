  ...
  <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <form:form method="POST" action="saveExpenseCategory.html" 
                        ...
                        <input type="hidden" name="expcategoryId" id="expcategoryId" value="${expenseCategory.expcategoryId}"/>
  							...
  							<div class="col-sm-6">
                                ...
                                <div class="hr-line-dashed"></div>
                                    <button class="btn btn-primary pull-right" type="submit" onclick="submitInventoryGroup()">Save</button>
                                </div>
                            </form:form>
                        </div>
                    </div>
...
function submitInventoryGroup(){
 var validator = $("#addExpenseCatForm").validate({
  rules: {                   
	  expcatName: "required",
  	},	
     errorElement: "span",                              
     messages: {
    	 expcatName: "Enter expense group name"
     }
 });
}
</script>           
