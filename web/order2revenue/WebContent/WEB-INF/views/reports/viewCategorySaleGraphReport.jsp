														...
														<table class="table table-bordered custom-table">
															...
															<tbody>
																<c:if test="${!empty categoryByTaxableSale}">
																	<c:forEach items="${categoryByTaxableSale}" var="partnerDto"
																		varStatus="loop">
																		<tr>
																			<td>${partnerDto.partner}</td>
														...
														<table class="table table-bordered custom-table">
															...
															<tbody>
																<c:if test="${!empty categoryByActualSale}">
																	<c:forEach items="${categoryByActualSale}" var="partnerDto"
																		varStatus="loop">
																		<tr>
																			<td>${partnerDto.partner}</td>
														...
														<table class="table table-bordered custom-table">
															...
															<tbody>
																<c:if test="${!empty categoryByTaxfreeSale}">
																	<c:forEach items="${categoryByTaxfreeSale}" var="partnerDto"
																		varStatus="loop">
																		<tr>
																			<td>${partnerDto.partner}</td>
