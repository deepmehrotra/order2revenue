...
<body>
												...
												<div class="float-e-margins graph-brd">
													<div class="ibox-content">
														<table class="table table-bordered custom-table">
															...
															<tbody>
																<c:if test="${!empty categoryByDiffNR}">
																	<c:forEach items="${categoryByDiffNR}" var="partnerDto"
																		varStatus="loop">
																		<tr>
												...
												<div class="float-e-margins graph-brd">
													<div class="ibox-content">
														<table class="table table-bordered custom-table">
															...
															<tbody>
																<c:if test="${!empty categoryByNetQty}">
																	<c:forEach items="${categoryByNetQty}" var="partnerDto"
																		varStatus="loop">
																		<tr>
																			<td>${partnerDto.key}</td>
	...
	<script>
		...
		<c:forEach items="${categoryByDiffNR}" var="partnerDto" varStatus="loop">
			var data = {};
		...
		<c:forEach items="${categoryByNetQty}" var="partnerDto" varStatus="loop">
			var data = {};
			data.name = '${partnerDto.key}';
