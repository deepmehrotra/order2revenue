                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>All SKUs(${eventsList.size()})</h5>
                        ...
                        <div class="scroll-y">
                             <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tr>
                                    ...
                                    <td><fmt:formatDate value="${event.eventCreatedDate}" pattern="MMM dd ,YY"/></td>
                                    <td>${event.eventChannel}</td>
                                    <td><fmt:formatDate value="${event.eventStartDate}" pattern="MMM dd ,YY"/></td>
                                    <td><fmt:formatDate value="${event.eventEndDate}" pattern="MMM dd ,YY"/></td>
