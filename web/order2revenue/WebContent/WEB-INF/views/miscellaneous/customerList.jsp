			...
			<div class="wrapper wrapper-content animated"
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="col-sm-6"
							style="text-align: right; margin-top: 20px; padding: 0px;">
							<span>Last</span>
										...
										<c:if test="${customer.customerPhnNo != null}">
											<tr>
												...
												<td style="color: blue;">
													<form action="viewCustomerOrders.html" method="POST">
														<input type="hidden" name="email"
															value="${customer.customerEmail}"> <input
															type="hidden" name="name"
															value="${customer.customerName}"> <input
															type="hidden" name="purchased"
															value="${customer.productPurchased}"> <input
															type="hidden" name="returned"
															value="${customer.productReturned}"> <input
															type="hidden" name="netPurchased"
															value="${customer.productPurchased-customer.productReturned}">
														<input type="hidden" name="revenue"
															value="${customer.netRevenue}">
												...
												<td><fmt:formatNumber type="number"
														maxFractionDigits="2" value="${customer.netRevenue}" /></td>
												<td>${customer.customerCity}</td>
												<td>${customer.customerEmail}<br>
													${customer.customerPhnNo}
												</td>
												<td><a href="#"><img src="/O2R/seller/img/edit.png"
														alt="edit"></a></td>
											</tr>
										</c:if>
									</c:forEach>
